...
MySQL - 10.4.27-MariaDB : Database - caruban_tourism
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`caruban_tourism` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;

USE `caruban_tourism`;

/*Table structure for table `additional_place_image` */
...
/*Data for the table `additional_place_image` */

insert  into `additional_place_image`(`id`,`image_1`,`image_2`,`image_3`,`image_4`) values 
(1,'https://asset.kompas.com/crops/FdTf8FFrnRaGfeAVUcKcMHvEkBM=/0x0:1199x799/780x390/data/photo/2021/05/24/60aa93b2c773f.jpg','https://radarcirebon.disway.id/upload/fbebe9ece592be87474569eee8ac4d4d.jpg','https://radarcirebon.disway.id/upload/2018/12/MUSEUM-KERATON-KASEPUHAN.gif','https://dynamic-media-cdn.tripadvisor.com/media/photo-o/05/62/a5/8d/keraton-kasepuhan.jpg?w=1200&h=-1&s=1'),
...
(2,'Nasi Lengko','Nasi Lengko or Sega Lengko or Lengko Rice The key components of the dish are white rice (ideally hot), fried tempeh, fried tofu, cucumbers (raw, freshly chopped), boiled bean sprouts, chives leaves (cut into small pieces), fried onions, peanut sauce (like salad seasoning, spicy or not depending on taste), and a light soy sauce poured over the top.','https://www.sabumiku.com/wp-content/uploads/2022/08/Makanan-Khas-Indramayu-dari-Nasi-Lengko.jpg','nasi lengko di cirebon'),
...
/*Data for the table `place_category` */
...
CREATE TABLE `places` (
  ...
  `additional_image_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `category_id` (`category_id`),
  KEY `additional_image_id` (`additional_image_id`),
...
(23,'fadli@gmail.com','$2b$10$lyE14XFGDUVTFn0g0wExweiXbf37KW8lm0l6ZtowbUbqBMcB2TyYK','Muhammad Fadli Fathurrahman','fadli','0891231241312'),
(24,'andri@gmail.com','$2b$10$yTDgxFAPP6VliBMaMudvee1KKjtFsVB47eixKv6iodDuvROVJh8q2','Andriansyah','andriansyah12','14131244212'),
(26,'mira2@gmail.com','$2b$10$20rSgDLYa/aC0ZLJf9h8/um9jo42fHcffwjL7vGHvzADFWw1iAG2u','Mira S','mira','089123123141');
